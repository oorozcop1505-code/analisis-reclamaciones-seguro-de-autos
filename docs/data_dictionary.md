...
| incident_location | VARCHAR | Calle y código postal del siniestro | |
| incident_hour_of_the_day | INT | Hora del día en que ocurrio el siniestro | Formato de 24 horas |
| number_of_vehicles_involved | INT | Número de vehículos involucrados | |
| property_damage | VARCHAR | ¿Hay daños a la propiedad? | YES - NO - ? |
| bodily_injuries | INT | Número de lesionados | |
| witnesses | INT | Número de testigos | | 
| police_reporte_avaliable | VARCHAR | Reporte de transito o pólicia disponible | YES - NO - ? |
| total_claim_amount | DECIMAL | Costo total de la reclamación | No contempla el pago del deducible |
| injury_claim | DECIMAL | Costo de lesiones reclamadas | No distingue entre asegurado, ocupantes o terceros |
| property_claim | DECIMAL | Costo de daños materiales reclamados | Incluye daños a bienes y vehículos |
| vehicle_claim | DECIMAL | Costo de daños al vehículo asegurado | No incluye el descuento del deducible |
| auto_make | VARCHAR | Fabricante del vehículo | | 
| auto_model | VARCHAR | Modelo del vehículo | |
| auto_year | INT | Año del vehículo | | 
| fraud_reported | CHAR | Se detecto fraude en este siniestro | Y para si - N para no | 
